    ...
    <div className="navbar-container">
      ...
      <div className="navbar-top-section">
        ...
        <div className="nav-icons">
          ...
          />
          <Link to="/cart">
            <img style={{ height: "22px" }} src={cart} alt="Logout" />
          </Link>
        </div>
      </div>
              ...
              <div className="dropdown-content">
                <div className="column">
                  <h4>
                    {" "}
                    <Link
                      to="/AllProducts/Indoor_lighting"
                      style={{ fontSize: "18px" }}
                    >
                      תאורת פנים
                    </Link>
                  </h4>
                  <Link to="/AllProducts/Hanging_lighting_fixtures">
                    גופי תאורה תלויים
                  </Link>
                  <div className="category">
                    <Link to="/AllProducts/Ceiling_mounted">
                      צמודי תקרה{" "}
                      <img
                        src={arrow}
                        style={{ width: "10px", marginRight: "5px" }}
                    ...
                    <div className="dropdown-absolute">
                      ...
                      <Link to="/AllProducts/Ceiling_fixtures">
                        גופי תאורה צמוד לתקרה
                      </Link>
                    </div>
                  </div>
                  ...
                  <div className="category">
                    <Link to="/AllProducts/Wall_mounted">
                      צמודי קיר{" "}
                      <img
                        src={arrow}
                        style={{ width: "10px", marginRight: "5px" }}
                  ...
                  <div className="category">
                    ...
                    <div className="dropdown-absolute">
                      ...
                      <Link to="/AllProducts/Concealed_lighting">
                        תאורה נסתרת
                      </Link>
                      <Link to="/AllProducts/Mashrabiya">משרביה</Link>
                    </div>
                  </div>
                  <Link to="/AllProducts/Magnetic_Profiles_and_Parts">
                    פס מגנטי
                  </Link>
                </div>
                <div className="column">
                  <h4>
                    {" "}
                    <Link
                      to="/AllProducts/Outdoor_lighting"
                      style={{ fontSize: "18px" }}
                    >
                      תאורת חוץ
                    </Link>
                  ...
                  <Link to="/AllProducts/Floor_recessed_lights">
                    שקועי רצפה
                  </Link>
